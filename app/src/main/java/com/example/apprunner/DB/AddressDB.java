...
public class AddressDB {
    ...
    public AddressDB(int id_add, String Address,String District,String MueangDistrict,String province,String Country_number,String Name,String Tel,int id_user){
        this.id_add = id_add;
