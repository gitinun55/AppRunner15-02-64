...
app.post('/add_address', function (req,res){
    ...
    dbConn.query('INSERT INTO reg_address (id_add,Address,District,MueangDistrict,province,Country_number,Name,Tel,id_user) VALUES (?,?,?,?,?,?,?,?,?)', [req.body.id_add,req.body.Address,req.body.District,req.body.MueangDistrict,req.body.province,
