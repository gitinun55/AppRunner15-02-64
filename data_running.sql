...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2021 at 07:26 PM
...
INSERT INTO `reg_address` (`id_address`, `id_user`, `id_add`, `Address`, `District`, `MueangDistrict`, `province`, `Country_number`, `Name`, `Tel`) VALUES
(54, 58, 182, 'หอ', 'ในเมือง', 'เมือง', 'ขอนแก่น', '40000', 'กิตินันท์ คนสอน', '0923956498');
...
(110, 182, 58, 'kitinun', 'khonson', '0923956498', '1300101186415', 'thai', 'AB', '4', 'Dad', 'บิดา', '0872490919', 'One Love Run', 'กัน', 'https://firebasestorage.googleapis.com/v0/b/vistual-running.appspot.com/o/images%2Fe5921e4b-3de4-4846-8369-38f4ebf255bd?alt=media&token=3901c3ee-100a-4d6a-b61c-ec8cbb5a7079', 1, 0, 1);
...
--
ALTER TABLE `add_event`
  MODIFY `id_add` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=183;
...
--
ALTER TABLE `history_payment`
  MODIFY `id_history_pament` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `history_uploadstatic`
--
ALTER TABLE `history_uploadstatic`
  MODIFY `id_history_UploadStatic` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `reg_address`
--
ALTER TABLE `reg_address`
  MODIFY `id_address` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `reg_event`
--
ALTER TABLE `reg_event`
  MODIFY `id_reg_event` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
